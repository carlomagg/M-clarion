            ...
            <div className='flex flex-col gap-2'>
                <div className='relative'>
                    ...
                    }
                    {
                        type === 'password' &&
                        (
                            <button onClick={() => {setShowPassword(!showPassword)}} type='button' className='absolute top-1/2 -translate-y-1/2 right-4'>
                                <img src={icon} alt="" />
                            </button>
                        )
                    }
    ...
    return (
        <div className='space-y-1'>
            ...
            <div className='relative'>
                ...
                type={type}
                name={name} 
                className='w-full p-4 pr-12 rounded-lg outline-button-pink border border-[#666]'
                onChange={onChange} 
                value={value} 
