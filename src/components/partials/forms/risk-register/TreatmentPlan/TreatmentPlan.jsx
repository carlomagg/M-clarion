...
function TreatmentPlan({onSetCurrentStep, riskName = ''}) {
        ...
        if (treatmentPlanQuery.data) {
            ...
            setFormData({
                ...
                details.action_plan.map(plan => {
                    ...
                    return {
                        action: plan.action || '',
                        assigned_to: plan.assigned_to || { id: '' },
    ...
    function handleAddPlan() {
        setFormData({
            ...
            action_plan: [
                ...
                {
                    action: '', 
                    assigned_to: { id: '' }, // Initialize with object structure
                    due_date: '', 
                    status_id: ''
                }
            ]
    ...
    function handleNextClicked() {
        ...
        // Format dates (if they exist) from MM-DD-YYYY to YYYY-MM-DD
        ...
        if (formattedData.action_plan && formattedData.action_plan.length > 0) {
            formattedData.action_plan = formattedData.action_plan.map(plan => {
                ...
                if (typeof newPlan.assigned_to === 'string' && newPlan.assigned_to.trim() !== '') {
                    newPlan.assigned_to = { id: newPlan.assigned_to };
                }
        ...
        // Log the formatted data to help debug
