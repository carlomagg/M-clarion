...
import { inherentRiskByPeriodOptions } from "../../../../../../queries/risks/dashboard";
...
export default function InherentRisksByPeriodCard() {
    const [period, setPeriod] = useState('Monthly');

    // query
    const {isLoading, error, data} = useQuery(inherentRiskByPeriodOptions(period.toLowerCase()));
    ...
    return (
        <Card title="Inherent Risk By Period" selectedPeriod={period} onSelectPeriod={setPeriod} classes="p-4 w-full" options={[]}>
