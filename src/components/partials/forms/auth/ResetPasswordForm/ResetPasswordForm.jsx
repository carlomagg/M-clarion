...
function ResetPasswordForm({ setResetSuccessful, type, email = null }) {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (type === "forgot-password") {
        url = "clarion_users/change_forgot_password/";
        data = {
          email: form.email,
        ...
        url = "clarion_users/user/change-password-first-login/";
        data = {
          new_password: form.new_password,
          confirm_new_password: form.confirm_new_password
        };
      } else if (type === "change-password") {
        url = "clarion_users/change-password/";
        data = {
      ...
      setFormError(error.response?.data?.error || error.response?.data?.message || "Unable to change password. Please try again.");
    } finally {
      setStatus("typing");
    }
  }
