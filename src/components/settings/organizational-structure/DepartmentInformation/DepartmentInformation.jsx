...
import { departmentOptions, departmentsOptions, divisionOptions, divisionsOptions, useActivateDepartment, useAddDepartment, useDeleteDepartment, useSuspendDepartment, useUpdateDepartment } from '../../../../queries/organization-queries';
...
function EditView({departmentId = null}) {
    ...
    useEffect(()=> {
        if (departmentId && department) {
            setFormData({
                ...
                division_id: department.coy_div,
            })
        }
    ...
    const isLoading = divisionsIsLoading || (departmentId && departmentIsLoading);
    const error = divisionsError || (departmentId && departmentError);
