                ...
                <div className="px-4 py-3">
                    <div className="mb-4 relative">
                        <select 
                            ...
                            className="w-full p-2 border border-gray-200 rounded-lg text-[13px] outline-none appearance-none bg-white pr-8"
                        >
                    ...
                    <div className="mb-1">
                        <textarea
                            ...
                            className="w-full h-[120px] p-2 border border-gray-200 rounded-lg text-[13px] outline-none resize-none"
                        />
                    </div>
