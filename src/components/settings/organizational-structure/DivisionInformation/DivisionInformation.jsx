    ...
    return (
        <div className='bg-white border border-[#CCC] p-6 flex flex-col gap-4 min-h-full'>
            <div className='flex flex-col gap-3'>
                <h3 className='font-semibold'>Divisions <span className='text-text-pink'>({divisions.length})</span></h3>
    ...
    return (
        <div className='bg-white border border-[#CCC] p-6 flex flex-col gap-8 min-h-full'>
            ...
            <div className='flex gap-6'>
                ...
                <FormProceedButton text={actionInProgress ? (action == 'add' ? 'Adding division...' : 'Saving changes...') : (action == 'add' ? 'Add division' :'Save changes')} onClick={handleSubmit} disabled={actionInProgress} />
            </div>
        </div>
    );
}
