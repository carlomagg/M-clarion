    ...
    return (
        <div className='bg-white border border-[#CCC] p-6 flex flex-col gap-4 min-h-full'>
            <div className='flex flex-col gap-3'>
                <div className='font-semibold'>Branches <span className='text-text-pink'>({branches.length})</span></div>
    ...
    return (
        <div className='bg-white border border-[#CCC] p-6 flex flex-col gap-8 min-h-full'>
            ...
            <div className='flex gap-6'>
                ...
                <FormProceedButton text={actionInProgress ? (action == 'add' ? 'Adding branch...' : 'Saving changes...') : (action == 'add' ? 'Add branch' :'Save changes')} onClick={handleSubmit} disabled={actionInProgress} />
            </div>
        </div>
    );
}
