...
export const SIDEBAR_MENU = [
    {link: '/', text: 'Home', icon: home, permission: null},
    {
        ...
        module: null,
        sub_menu: [
            {link: '/users', text: 'Manage users', permission: 'manage_users'},
            {link: '/settings', text: 'User preferences', permission: 'user_groups'},
        ]
    },
    // {
    //     link: '/strategies',
    ...
    // },
    {
        ...
        module: 'risk',
        sub_menu: [
            {link: 'dashboard', text: 'Dashboard', permission: 'risk-dashboard'},
            {link: 'register', text: 'Register', permission: 'risk-register'},
        ]
    },
    {
...
export const SETTINGS_MENU = [
    ...
    {link: 'location', text: 'Location', icon: home, permission: 'location'},
